...
function Browser() {
  ...
  useEffect(() => {
    ...
    honestoneAPI
      .get(
        "http://Honestone-env.eba-k4swcanf.eu-central-1.elasticbeanstalk.com/deck/all-public"
      )
      .then((resp) => setDecks(resp.data))
      .then(() =>
        honestoneAPI
          .get(
            "http://Honestone-env.eba-k4swcanf.eu-central-1.elasticbeanstalk.com/deck/most-recent/40"
          )
